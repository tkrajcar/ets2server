...
# debconf-set-selections <<< 'mysql-server mysql-server/root_password password kk'
# debconf-set-selections <<< 'mysql-server mysql-server/root_password_again password kk'
sudo apt-get update
sudo apt-get install -q -y git-core curl autoconf bison build-essential libssl-dev libyaml-dev libreadline6-dev zlib1g-dev libncurses5-dev libffi-dev vim
SCRIPT
